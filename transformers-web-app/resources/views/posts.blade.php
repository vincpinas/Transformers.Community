        ...
        <nav class="navbar navbar-expand-lg navbar-light c-bg-purple c-tw">
            <div class="container-fluid">
              ...
              <a class="navbar-brand" href="#">
                <img src="{{ asset("/images/logo.svg") }}" class="c-logo-80 d-none d-lg-block">
              </a>
        ...
        @foreach ($posts as $post)
            <article class="c-post-card">
                <a href="{{ route("post.show", ["post" => $post]) }}">
                    <img src="{{ asset("images/cat-covers/".$post->category->name.".jpg") }}" alt="{{ $post->category->name}} cover">
                </a>
                <div>
                    <h2>
                        <a href="{{ route("post.show", ["post" => $post]) }}" class="c-titles-font">{!! $post->title !!}</a>
                    </h2>
                    <p class="text-ellipsis">
                        {{ $post->excerpt }}
                    </p>
                    <p>
                        <a href="/author/{{ $post->author->username }}">{{ $post->author->name }}</a> | <a href="/categories/{{ $post->category->slug }}" style="color:var(--orange);text-decoration:underline;">{{ $post->category->name }}</a>
                    </p>
                </div>
            </article>
        @endforeach
